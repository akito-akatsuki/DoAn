...
export default function MessagesPage() {
  ...
  return (
    <div className="h-screen flex flex-col text-gray-900 dark:text-gray-100 transition-colors duration-500 overflow-hidden bg-gray-50 dark:bg-neutral-900 overscroll-none touch-pan-y">
          ...
          >
            {!targetUser ? (
              ...
              <div className="flex-1 w-full h-full relative flex overflow-hidden">
                {/* --- CHAT VIEW --- */}
                <div
                  className={`absolute inset-0 flex flex-col transition-transform duration-300 ease-in-out bg-white dark:bg-[#262626] z-10 md:rounded-xl md:rounded-l-none ${isSettingsOpen ? "-translate-x-full" : "translate-x-0"}`}
                >
                  {/* HEADER CHAT */}
                  <div className="p-4 border-b border-gray-200 dark:border-neutral-800 flex items-center gap-3 rounded-t-xl md:rounded-tr-xl md:rounded-tl-none shrink-0 shadow-[0_2px_10px_rgba(0,0,0,0.02)] dark:shadow-black/20 bg-white dark:bg-[#262626] z-20">
                  ...
                  <div className="flex flex-col border-t border-gray-200 dark:border-neutral-800 rounded-b-xl shrink-0 transition-colors duration-500 bg-white dark:bg-[#262626] shadow-[0_-2px_10px_rgba(0,0,0,0.02)] dark:shadow-black/20">
                    ...
                    {imageFiles.length > 0 && (
                      <div className="p-4 pb-0 flex gap-2 overflow-x-auto snap-x [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
                        {imageFiles.map((f, i) => (
                          <div
                            key={i}
                          ...
                          >
                            <img
                              ...
                              alt="preview"
                              className="h-20 w-auto rounded-lg object-contain border border-gray-200 dark:border-neutral-700 shadow-sm"
                            />
                            <button
                              onClick={() =>
                                setImageFiles((prev) =>
                ...
                {/* --- SETTINGS VIEW --- */}
                <div
                  className={`absolute inset-0 flex flex-col transition-transform duration-300 ease-in-out bg-gray-50 dark:bg-[#333333] z-20 md:rounded-xl md:rounded-l-none ${isSettingsOpen ? "translate-x-0" : "translate-x-full"}`}
                >
                  <div className="p-4 flex items-center gap-2 border-b border-gray-200 dark:border-neutral-800 bg-white dark:bg-[#262626] shrink-0 md:rounded-tr-xl z-20 shadow-[0_2px_10px_rgba(0,0,0,0.02)] dark:shadow-black/20">
                    <button
                      onClick={() =>
                        settingsView === "menu"
                          ? setIsSettingsOpen(false)
                        ...
                        {groupMembers.map((member) => (
                          ...
                          >
                            ...
                            <span className="font-semibold text-[15px]">
                              {member.name} {member.id === user?.id && "(Bạn)"}
                            </span>
                          </div>
                        ))}
                      </div>
